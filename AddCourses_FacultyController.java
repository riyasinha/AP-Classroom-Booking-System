...
/**
 * this is the add course controller that displays all the courses available.
 * It also displays the search bar where one can search for the course using the post conditions.
 */
public class AddCourses_FacultyController {
    ...
    /**
     * 
     * @param e when enter is pressed in the search field text field it displays only those courses that satisfy the post conditions
     * 
     * @throws IOException
     */
    ...
    public void BackButtonHandler(ActionEvent e) throws IOException
	{
		...
		if(e.getSource()== btnback)
		{
        	...
        	FacultyProfilePageController student = loader.<FacultyProfilePageController>getController();
    ...
    public void CourseButtonHandler(ActionEvent e)throws IOException
    {
    	...
    	if(e.getSource()==btndm)
    	{
    		Stage stage = null;
        	Parent root = null;
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/CourseInfoPage_Faculty.fxml"));
        	stage = (Stage)btndm.getScene().getWindow();
        	root = (Parent)loader.load();
        	CourseInfo_FacultyController course = loader.<CourseInfo_FacultyController>getController();
        	//student.displayemail.setText(emailadd.getText());
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 1;
    	...
    	if(e.getSource()==btnap)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 2;
    	...
    	if(e.getSource()==btnco)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 3;
    	...
    	if(e.getSource()==btnm3)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 4;
    	...
    	if(e.getSource()==btnsns)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 5;
    	...
    	if(e.getSource()==btnra)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 6;
    	...
    	if(e.getSource()==btnnt)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 7;
    	...
    	if(e.getSource()==btnpok)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 8;
    	...
    	if(e.getSource()==btnpsy)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 9;
    	...
    	if(e.getSource()==btntpee)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 10;
    	...
    	if(e.getSource()==btnta)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 11;
    	...
    	if(e.getSource()==btnes)
    	{
        	...
        	//System.out.println(Main.college.courses.get(0).credits);
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 12;
    	...
    	if(e.getSource()==btnide)
    	{
        	...
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 13;
    	...
    	if(e.getSource()==btnims)
    	{
        	...
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 14;
    	...
    	if(e.getSource()==btnpo)
    	{
        	...
        	//course.txtcode.
        	CourseInfo_FacultyController.n = 16;
