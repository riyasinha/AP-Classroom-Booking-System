...
/**
 * 
 * This page allows the faculty to choose options in order to book his or her
 * room 
 *
 */
public class BookRoom_FacultyController extends WelcomePageController {
	/**
	 * @param rs1,rs2,.... these are the radiobuttons for start time
	 * @param re1,re2,re3.... these are the radiobuttons for end time
	 * @param String starttime is the starting time of the class
	 * @param String endtime is the ending time of the class
	 */
...
//	MenuItem start19 = new MenuItem("05:30");
	...
	*/
	...
	/**
	 * 
	 * @param e search room searches whether the given room is booked or free and then redirects the
	 * faculty to find out about different rooms
	 * @param btnsearchroom takes in the field and searcher room according to the time slot
	 * @throws IOException
	 */
	public void SearchRoomHandler(ActionEvent e)throws IOException
	{
		...
		if(e.getSource()== btnsearchroom)
		{
		     ...
		     selectdate = pickdate.getValue().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
	        	...
	        	FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/BookRoom2_FacultyPage.fxml"));
	        	stage = (Stage)btnsearchroom.getScene().getWindow();
	        	root = (Parent)loader.load();
	        	BookRoom2_FacultyController bookfaculty = loader.<BookRoom2_FacultyController>getController();
    ...
    /**
     * 
     * @param e back button redirects to the faculty profile page 
     * @throws IOException
     */
