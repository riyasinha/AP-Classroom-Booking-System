...
/**
 * course info page displays the course informations for that particular course.
 * this page is the next stage for the add courses stage
 * @author riyas
 *
 */
public class CourseInfo_FacultyController implements Initializable{
